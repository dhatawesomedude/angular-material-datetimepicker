(function (window, angular) {
  ...
  angular.module(moduleName, ['ngMaterial', 'angularMoment'])
    ...
    .factory('mdcDefaultParams', ['mdcDatetimePickerDefaultLocale', function (mdcDatetimePickerDefaultLocale) {
      ...
      return default_params;
        ...
        .directive('mdcDatetimePicker', ['$mdDialog', '$timeout', 'moment',
            function ($mdDialog, $timeout, moment) {
  ...
  ;
    ...
    var PluginController = function ($scope, $mdDialog, mdcDefaultParams, moment) {
  ...
  PluginController.$inject = ['$scope', '$mdDialog', 'mdcDefaultParams', 'moment'];
  PluginController.prototype = {
    ...
    initDates: function () {
      ...
      this.disableDates = this.params.disableDates.map(function (x) {
        return this.moment(x).format('MMMM Do YYYY');
      });
